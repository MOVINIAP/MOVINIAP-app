...
router.get(
  '/solicitudes/empleado/solicitudes-sin-informe/:id',
  getListRequestsAcceptedWithoutReportByEmployeeId
);
router.post('/solicitudes/nueva-solicitud', createRequest);
router.put('/solicitudes/:idSolicitud/editar-solicitud', updateRequest);
router.post(
  '/solicitudes/:idSolicitud/transporte',
  registrarTransporteSolicitud
);
router.put('/solicitudes/transporte/:id/editar', editarTransporteSolicitud);
router.delete(
  '/solicitudes/transporte/:id/eliminar',
  eliminarTransporteSolicutud
);
